...
var R3TemplateRef = class TemplateRef2 extends ViewEngineTemplateRef {
  ...
  createEmbeddedViewImpl(context2, injector, hydrationInfo) {
    const embeddedLView = createAndRenderEmbeddedLView(this._declarationLView, this._declarationTContainer, context2, { injector, hydrationInfo });
...
function handleInjectEvent(context2, data) {
  ...
  instantiatedTokenToDependencies.get(context2.token).push({ token, value, flags });
}
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-QIQHYZ74.js.map
